  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 animate-fade-in">
      ...
      <Card className="card-elevated group hover:shadow-glow transition-shadow duration-500">
        ...
        <CardContent className="space-y-4 pt-6">
          {/* Header */}
          <div className="hidden md:grid md:grid-cols-[28px_minmax(0,2fr)_minmax(0,3fr)_60px_60px_80px_100px_60px_70px_90px_auto] gap-1.5 text-xs font-medium text-primary uppercase tracking-wider border-b border-primary/20 pb-3 mx-3 mt-1 items-end">
            <div></div>
